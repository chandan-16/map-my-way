...
const CampSite = ({ backgroundImage, title, subtitle, peopleJoined } : CampProps) => {
  return(
    <div className={`h-full w-full min-w-[1100px] ${backgroundImage} bg-cover bg-no-repeat lg:rounded-r-5xl 2xl:rounded-5xl`}>
      <div className="flex h-full flex-col items-center justify-between p-6 lg:px-20 lg:py-10">
        ...
        <div className="flexCenter gap-6">
          <span className="flex -space-x-4 overflow-hidden">
            ...
            <p className="bold-16 md:bold-20 text-white pl-6 pt-1">{peopleJoined}</p>
          </span>
        </div>
      </div>
    </div>
...
const Camp = () => {
  return (
    <section className="2xl:max-container relative flex flex-col py-10 lg:mb-10 lg:py-20 xl:mb-20">
      <div className=" flex h-[340px] w-full items-start justify-start gap-8 overflow-x-auto lg:[400px] xl:h-[640px]">
        <CampSite backgroundImage="bg-bg-img-1" title="Putuk Truno Camp" subtitle="Prigen, Pasuruan" peopleJoined="50+ Joined" />

        <CampSite backgroundImage="bg-bg-img-2" title="Mountain Viw Camp" subtitle="Somewhere in the Wilderness" peopleJoined="50+ Joined" />
      </div>
